...
import cn.pidb.engine.blob.extensions.TxStateExtension;
 ...
 * works.
 */
public class TxState extends TxStateExtension implements TransactionState, RelationshipVisitor.Home
{
    /**
