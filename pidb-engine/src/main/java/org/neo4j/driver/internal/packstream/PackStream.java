...
import cn.pidb.engine.blob.extensions.Neo4jConfigAware;
...
public class PackStream {
    ...
    //NOTE: Neo4jConfigAware
    public static class Packer extends Neo4jConfigAware {
        ...
        public void pack(Blob value) throws IOException {
            if (value == null) {
                packNull();
            } else {
                BlobIO.writeBlob(value, this);
            }
        }
        ...
        public void pack(Blob[] value) throws IOException {
            if (value == null) {
                ...
                BlobIO.writeBlobArray(value, this);
            }
        }
